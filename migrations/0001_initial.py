# Generated by Django 3.1.1 on 2021-06-08 23:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_no', models.CharField(max_length=128)),
            ],
        ),
        migrations.CreateModel(
            name='Trial',
            fields=[
                ...
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='pipr3.participant')),
                ('stimulus', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='pipr3.stimulus')),
            ],
        ),
        migrations.CreateModel(
            name='Language',
